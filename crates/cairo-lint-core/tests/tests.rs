...
// test_file!(manual, manual_ok, "test basic ok", "test basic if ok", "test other var", "test if
// other var");

// test_file!(manual, manual_err, "test basic err", "test basic if err", "test other err", "test if
// other err");
